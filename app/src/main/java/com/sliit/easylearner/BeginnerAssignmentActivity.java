...
public class BeginnerAssignmentActivity extends AppCompatActivity {
    ...
    private static final String URL_LETTERS_ASSIGNMENT = "https://easylearntamil.000webhostapp.com/beginner-assignment";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_beginner_assignment);
        ...
        chronometer.setOnChronometerTickListener(new Chronometer.OnChronometerTickListener() {
            ...
            public void onChronometerTick(Chronometer chronometer) {
                if ((SystemClock.elapsedRealtime() - chronometer.getBase()) >= 100000000) {
                    chronometer.setBase(SystemClock.elapsedRealtime());
                    Toast.makeText(BeginnerAssignmentActivity.this, "Bing!", Toast.LENGTH_SHORT).show();
                }
            }
        });
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (error){
                                ...
                                Toast.makeText(BeginnerAssignmentActivity.this, "Error Data", Toast.LENGTH_SHORT).show();
                            }
