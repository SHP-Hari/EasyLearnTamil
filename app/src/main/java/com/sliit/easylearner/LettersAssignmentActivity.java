...
public class LettersAssignmentActivity extends AppCompatActivity {
    ...
    private static final String URL_LETTERS_ASSIGNMENT = "https://easylearntamil.000webhostapp.com/letters-assignment";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_letters_assignment);
        ...
        chronometer.setOnChronometerTickListener(new Chronometer.OnChronometerTickListener() {
            ...
            public void onChronometerTick(Chronometer chronometer) {
                if ((SystemClock.elapsedRealtime() - chronometer.getBase()) >= 100000000) {
                    chronometer.setBase(SystemClock.elapsedRealtime());
                    Toast.makeText(LettersAssignmentActivity.this, "Bing!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void loadQuestions() {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_LETTERS_ASSIGNMENT,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (error){
                                ...
                                Toast.makeText(LettersAssignmentActivity.this, "Error Data", Toast.LENGTH_SHORT).show();
                            }
    ...
    private void updateQuestion(){
        ...
        if (mIndex == 0){
            db.insertAssignmentTotalMarks(1, mScore, 1);
            for (int i = 0; i<timeTaken.size(); i++){
                db.insertAssignmentTime(1, i, timeTaken.get(i));
            }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            JSONObject jsonObject = new JSONObject(response);
                            int userlevel;
                            userlevel = jsonObject.getInt("predictions_NB");
                            if (userlevel == 1){
                                AlertDialog.Builder alert = new AlertDialog.Builder(LettersAssignmentActivity.this);
                            ...
                            e.printStackTrace();
                            Toast.makeText(LettersAssignmentActivity.this, "cannot read user level", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        db.deleteallAssignmentStatusAndMarks();
                        Toast.makeText(LettersAssignmentActivity.this, "Something went wrong. Please go back and Try Again", Toast.LENGTH_SHORT).show();
                    }
                });
